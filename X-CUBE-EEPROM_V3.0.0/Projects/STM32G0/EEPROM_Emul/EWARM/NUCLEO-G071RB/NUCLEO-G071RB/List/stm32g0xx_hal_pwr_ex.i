...
void HAL_PWREx_EnableBatteryCharging(uint32_t ResistorSelection)
{
  ...
  tmpreg = (((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR4 & ~(0x1UL << (9U)));
  ((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR4 = (tmpreg | ResistorSelection | (0x1UL << (8U)));
}
...
void HAL_PWREx_DisableBatteryCharging(void)
{
  ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR4) &= ~((0x1UL << (8U))));
}
...
void HAL_PWREx_EnablePORMonitorSampling(void)
{
  ((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR3 |= (0x1UL << (9U));
}
...
void HAL_PWREx_EnableInternalWakeUpLine(void)
{
  ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR3) |= ((0x1UL << (15U))));
}
...
HAL_StatusTypeDef HAL_PWREx_EnableGPIOPullUp(uint32_t GPIO, uint32_t GPIONumber)
{
  ...
  {
    case (0x00000000u):
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PUCRA) |= ((GPIONumber & ~(0x1UL << (14U)))));
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PDCRA) &= ~((GPIONumber & ~(0x1UL << (13U)))));
       break;

    case (0x00000001u):
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PUCRB) |= (GPIONumber));
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PDCRB) &= ~(GPIONumber));
       break;

    case (0x00000002u):
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PUCRC) |= (GPIONumber));
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PDCRC) &= ~(GPIONumber));
       break;

    case (0x00000003u):
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PUCRD) |= (GPIONumber));
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PDCRD) &= ~(GPIONumber));
       break;

    case (0x00000005u):
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PUCRF) |= (GPIONumber));
       ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->PDCRF) &= ~(GPIONumber));
       break;
...
void HAL_PWREx_EnablePullUpPullDownConfig(void)
{
  ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR3) |= ((0x1UL << (10U))));
}
...
void HAL_PWREx_EnableSRAMRetention(void)
{
  ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR3) |= ((0x1UL << (8U))));
}
...
void HAL_PWREx_EnableFlashPowerDown(uint32_t PowerMode)
{
  ...
  ((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR1 |= PowerMode;
}
...
uint32_t HAL_PWREx_GetVoltageRange(void)
{
  return (((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR1 & (0x3UL << (9U)));
}
...
HAL_StatusTypeDef HAL_PWREx_ControlVoltageScaling(uint32_t VoltageScaling)
{
  ...
  (((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR1)) = ((((((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR1))) & (~((0x3UL << (9U))))) | (VoltageScaling))));

   
  if(VoltageScaling == (0x1UL << (9U)))
  {
     
    wait_loop_index = ((6u * SystemCoreClock ) / 1000000U) + 1U;

     
    while((((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->SR2) & ((0x1UL << (10U)))) == ((0x1UL << (10U)))))
    {
...
void HAL_PWREx_EnableLowPowerRunMode(void)
{
  ...
  ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR1) |= ((0x1UL << (14U))));
}
...
HAL_StatusTypeDef HAL_PWREx_DisableLowPowerRunMode(void)
{
  uint32_t wait_loop_index = ((6u * SystemCoreClock ) / 1000000U) + 1U;

   
  ((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR1) &= ~((0x1UL << (14U))));

   
  while((((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->SR2) & ((0x1UL << (9U)))) == ((0x1UL << (9U)))))
  {
    if(wait_loop_index != 0U)
    {
      wait_loop_index--;
...
void HAL_PWREx_EnterSHUTDOWNMode(void)
{
  ...
  (((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR1)) = ((((((((PWR_TypeDef *) (((0x40000000UL)) + 0x00007000UL))->CR1))) & (~((0x7UL << (0U))))) | (((0x4UL << (0U)))))));
