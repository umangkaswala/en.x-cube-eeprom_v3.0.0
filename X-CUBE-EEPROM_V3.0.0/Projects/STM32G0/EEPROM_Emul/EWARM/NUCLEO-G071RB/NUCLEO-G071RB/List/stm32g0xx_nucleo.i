...
GPIO_TypeDef*  LED_PORT[1] = {((GPIO_TypeDef *) ((0x50000000UL) + 0x00000000UL))};
const uint16_t LED_PIN[1] = {((uint16_t)0x0020)};

GPIO_TypeDef*  BUTTON_PORT[1] = {((GPIO_TypeDef *) ((0x50000000UL) + 0x00000800UL))};
const uint16_t BUTTON_PIN[1] = {((uint16_t)0x2000)};
const uint8_t  BUTTON_IRQn[1] = {EXTI4_15_IRQn };
...
uint32_t BSP_GetVersion(void)
{
  return (((0x01U) << 24) |((0x01U) << 16) |((0x00U) << 8 ) |((0x00U)));
}
...
void BSP_LED_Init(Led_TypeDef Led)
{
  ...
  do { if((Led) == 0) do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->IOPENR) |= ((0x1UL << (0U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->IOPENR) & ((0x1UL << (0U)))); (void)tmpreg; } while(0U);} while(0);

   
  gpioinitstruct.Pin = LED_PIN[Led];
  gpioinitstruct.Mode = (0x00000001u);
  gpioinitstruct.Pull = (0x00000000u);
  gpioinitstruct.Speed = (0x00000003u);
...
void BSP_PB_Init(Button_TypeDef Button, ButtonMode_TypeDef ButtonMode)
{
  ...
  do { if((Button) == 0) do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->IOPENR) |= ((0x1UL << (2U)))); tmpreg = ((((RCC_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00001000UL))->IOPENR) & ((0x1UL << (2U)))); (void)tmpreg; } while(0U);} while(0);
