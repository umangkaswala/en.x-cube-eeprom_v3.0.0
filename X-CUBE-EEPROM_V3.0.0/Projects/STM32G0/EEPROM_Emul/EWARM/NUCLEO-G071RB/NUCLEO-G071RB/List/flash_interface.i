...
HAL_StatusTypeDef FI_WriteDoubleWord(uint32_t Address, uint64_t Data)
{
  return HAL_FLASH_Program((0x1UL << (0U)), Address, Data); 
}
...
EE_Status FI_PageErase(uint32_t Page, uint16_t NbPages)
{
  ...
  s_eraseinit.TypeErase   = (0x1UL << (1U));
...
EE_Status FI_DeleteCorruptedFlashAddress(uint32_t Address)
{
  ...
  *(volatile uint32_t*)(Address) = (uint32_t)0U;
  *(volatile uint32_t*)(Address+4U) = (uint32_t)0U;

   
  while(((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR & (0x1UL << (16U)))
  {
  }
  
   
  if((((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR & (0x1UL << (1U)))  || (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR & (0x1UL << (3U))) ||
     (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR & (0x1UL << (4U))) || (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR & (0x1UL << (5U)))  ||
     (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR & (0x1UL << (6U))) || (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR & (0x1UL << (7U))))
  {
    status = EE_DELETE_ERROR;
  }

   
  if (((FLASH_TypeDef *) (((0x40000000UL) + 0x00020000UL) + 0x00002000UL))->SR & (0x1UL << (0U)))
  {
